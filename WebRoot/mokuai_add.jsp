	...
	<div class="main-wraps">
		...
		<div class="crumb-wrap">
			<div class="crumb-list">
				<i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span
					...
					href="/jscss/admin/design/">模块信息</a><span class="crumb-step">&gt;</span><span>新增新闻模块</span>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
		...
		<div class="result-wrap">
			<div class="result-content">
				<form action="${pageContext.request.contextPath}/mokuai/insertM"
					method="post">
						...
						<tbody>
							<tr>
								...
								<td><input class="common-text required"
									id="mokuai.title" name="mokuai.title" size="50"
									value="" type="text">
								</td>
							</tr>
							<tr>
